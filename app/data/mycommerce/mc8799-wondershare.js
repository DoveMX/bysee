(function(){
    ...
    var products = {
            "For PC": [
                /// 针对PC的常用产品
                {
                    ...
                    "BuyUrl":"https://shopper.mycommerce.com/checkout/cart/new/8799-211?quantity=1&locale=zh_CN&currency=USD&affiliate_id=624209&affiliate=624209",
                ...
                ,{
                    ...
                    "BuyUrl":"https://shopper.mycommerce.com/checkout/cart/new/8799-263?quantity=1&locale=zh_CN&currency=USD&affiliate_id=624209&affiliate=624209",
            ...
            "Dr.fone for iOS": [
                /// iOS Unlock Tool
                {
                    ...
                    "DownloadUrl":"https://romanysoft.com/files/wondershare/drfone_unlock_setup_full.exe",
                ...
                ,{
                    ...
                    "DownloadUrl":"https://romanysoft.com/files/wondershare/drfone_unlock_full.dmg",
                ...
                ,{
                    ...
                    "DownloadUrl":"https://romanysoft.com/files/wondershare/drfone_recover_setup_full.exe",
                ...
                ,{
                    ...
                    "DownloadUrl":"https://romanysoft.com/files/wondershare/drfone_full.dmg",
    ...
    var want_load_products = []
    var all_series_key_list = _.keys(products)

    _.each(all_series_key_list, function(one_series_key) {
        var data_product_list = _.get(products, [one_series_key]) || []
        if (data_product_list.length > 0) {
    ...
    window["SellerData"] = _.concat(window["SellerData"] || [], want_load_products);
})();